...
/**
 * The function `getServicesAuth` is an asynchronous function that sends a request to a specified URL
 ...
 * @param method - The `method` parameter in the `getServicesAuth` function specifies the HTTP method
 ...
 * @param url - The `url` parameter in the `getServicesAuth` function is the URL to which the HTTP
 * request will be sent. It specifies the location of the server resource that the request is being
 * made to.
 * @returns The `getServicesAuth` function is returning a Promise that resolves to the result of the
 ...
 */
/*async function getServicesAuth(data, method, url) {
  let parameters;
    parameters = {
      method: method,
      mode: 'cors',
